/* @ts-self-types="./securepass_analyzer.d.ts" */
...
export function analyze_password(password) {
    ...
    const ret = wasm.analyze_password(ptr0, len0);
    return ret;
}
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./securepass_analyzer_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('securepass_analyzer_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
